...
async function getWeather(city = "Minsk") {
    ...
    const timeZoneResponse = await fetch(`https://api.timezonedb.com/v2.1/get-time-zone?key=95WHPNRO6JMC&format=json&by=position&lat=${data.city.coord.lat}&lng=${data.city.coord.lon}`)
